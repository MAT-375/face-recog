...
# pip install numpy
# Visual Studio Build Tools Required -> C++ Desktop Development Tools
...
# Load Known Faces
# upload images in "faces" folder and rename the following as required
...
person3_image = face_recognition.load_image_file("faces/person3.jpg")
person3_encoding = face_recognition.face_encodings(person3_image)[0]

person4_image = face_recognition.load_image_file("faces/person4.jpg")
...
known_face_names = ["Person1", "Person2", "Person3", "Person4"]
